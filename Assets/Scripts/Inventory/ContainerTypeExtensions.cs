...
namespace MinecraftClient.Inventory
{
    public static class ContainerTypeExtensions
    {
        ...
        public static string GetAsciiArt(this ContainerType c)
        {
            switch (c)
            {
                case ContainerType.PlayerInventory:
                    return getTextOrNull("PlayerInventory");
                case ContainerType.Generic_9x3:
                    return getTextOrNull("Generic_9x3");
                case ContainerType.Generic_9x6:
                    return getTextOrNull("Generic_9x6");
                case ContainerType.Generic_3x3:
                    return getTextOrNull("Generic_3x3");
                case ContainerType.Crafting:
                    return getTextOrNull("Crafting");
                ...
                case ContainerType.BrewingStand:
                    return getTextOrNull("BrewingStand");
        ...
        private static string getTextOrNull(string name)
        {
            try {
                return File.ReadAllText(Application.streamingAssetsPath + "/Containers/ContainerType." + name + ".txt");
            } catch {
                return null;
            }
        }
