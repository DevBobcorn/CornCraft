...
namespace MinecraftClient.Protocol.Session
{
    ...
    public static class SessionCache
    {
        ...
        public static void Store(string login, SessionToken session)
        {
            ...
            if (CornCraft.SessionCaching == CacheType.Disk && updatetimer.Enabled == true)
            {
                pendingadds.Add(new KeyValuePair<string, SessionToken>(login, session));
            }
            else if (CornCraft.SessionCaching == CacheType.Disk)
            {
                SaveToDisk();
            }
        }
        ...
        private static void SaveToDisk()
        {
            ...
            sessionCacheLines.Add("# Generated by CornClient " + CornCraft.Version + " - Edit at own risk!");
