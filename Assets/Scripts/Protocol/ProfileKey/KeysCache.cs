...
namespace MinecraftClient.Protocol.Keys
{
    ...
    public static class KeysCache
    {
        ...
        public static void Store(string login, PlayerKeyPair playerKeyPair)
        {
            ...
            if (CornCraft.ProfileKeyCaching == CacheType.Disk && updatetimer.Enabled == true)
            {
                pendingadds.Add(new KeyValuePair<string, PlayerKeyPair>(login, playerKeyPair));
            }
            else if (CornCraft.ProfileKeyCaching == CacheType.Disk)
            {
                SaveToDisk();
            }
        }
        ...
        private static void SaveToDisk()
        {
            ...
            KeysCacheLines.Add("# Generated by CornClient " + CornCraft.Version + " - Edit at own risk!");
