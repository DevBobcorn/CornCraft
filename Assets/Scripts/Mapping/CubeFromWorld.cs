...
namespace MinecraftClient.Mapping
{
    ...
    public static class CubeFromWorld
    {
        ...
        public static Cube GetBlocksAsCube(World currentWorld, Location startBlock, Location stopBlock, List<ResourceLocation> materialList = null, bool isBlacklist = true)
        {
                ...
                foreach (int x in iterateX)
                {
                    ...
                    foreach (int z in iterateZ)
                    {
                        if (materialList != null && materialList.Count > 0)
                        {
                            ...
                            ResourceLocation tempBlockId = currentWorld.GetBlock(tempLocation).BlockId;
                            ...
                            if (isBlacklist ^ materialList.Contains(tempBlockId))
                            {
