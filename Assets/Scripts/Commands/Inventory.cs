            ...
            if (args.Length >= 1)
            {
                ...
                if (args[0].ToLower() == "creativegive")
                {
                    if (args.Length >= 4)
                    {
                        ...
                        {
                            if (handler.PlayerData.GameMode == GameMode.Creative)
                            {
                ...
                else if (action == "list")
                {
                    ...
                    int selectedHotbar = handler.PlayerData.CurrentSlot + 1;
                    ...
                    if (inventoryId == 0)
                        response.AppendLine(Translations.Get("cmd.inventory.hotbar", (handler.PlayerData.CurrentSlot + 1)));
