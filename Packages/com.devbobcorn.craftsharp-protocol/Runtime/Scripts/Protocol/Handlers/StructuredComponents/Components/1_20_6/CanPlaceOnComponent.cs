...
{
    public class CanPlaceOnComponent : StructuredComponent
    {
        public int NumberOfPredicates { get; set; }
        public List<BlockPredicateSubcomponent> BlockPredicates { get; set; } = new();
        public bool ShowInTooltip { get; set; }

        public CanPlaceOnComponent(DataTypes dataTypes, ItemPalette itemPalette, SubComponentRegistry subComponentRegistry) 
