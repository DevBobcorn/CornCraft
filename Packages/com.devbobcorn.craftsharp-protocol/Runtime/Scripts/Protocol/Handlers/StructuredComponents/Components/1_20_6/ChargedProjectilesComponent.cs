...
{
    public class ChargedProjectilesComponent : StructuredComponent
    {
        public int NumberOfItems { get; set; }
        public List<ItemStack?> Items { get; set; } = new();

        public ChargedProjectilesComponent(DataTypes dataTypes, ItemPalette itemPalette, SubComponentRegistry subComponentRegistry) 
