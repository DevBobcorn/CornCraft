...
namespace CraftSharp.Protocol.Handlers.PacketPalettes
{
    public class PacketPalette1204 : PacketTypePalette
    {
        private readonly Dictionary<int, PacketTypesIn> typeIn = new()
        {
            ...
            { 0x31, PacketTypesIn.OpenInventory },              // (Wiki name: Open Screen)
        ...
        private readonly Dictionary<int, PacketTypesOut> typeOut = new()
        {
            ...
            { 0x0C, PacketTypesOut.ClickInventoryButton },        // (Wiki name: Click Container Button)
            { 0x0D, PacketTypesOut.ClickInventory },              // (Wiki name: Click Container)
            { 0x0E, PacketTypesOut.CloseInventory },              // (Wiki name: Close Container (serverbound))
            { 0x0F, PacketTypesOut.ChangeInventorySlotState },    // Added in 1.20.3
