...
namespace CraftSharp.Protocol.Handlers.PacketPalettes
{
    public class PacketPalette1162 : PacketTypePalette
    {
        private readonly Dictionary<int, PacketTypesIn> typeIn = new()
        {
            ...
            { 0x11, PacketTypesIn.InventoryConfirmation },
            { 0x12, PacketTypesIn.CloseInventory },
            { 0x13, PacketTypesIn.InventoryItems },
            { 0x14, PacketTypesIn.InventoryProperty },
            ...
            { 0x2D, PacketTypesIn.OpenInventory },
        ...
        private readonly Dictionary<int, PacketTypesOut> typeOut = new()
        {
            ...
            { 0x07, PacketTypesOut.InventoryConfirmation },
            { 0x08, PacketTypesOut.ClickInventoryButton },
            { 0x09, PacketTypesOut.ClickInventory },
            { 0x0A, PacketTypesOut.CloseInventory },
