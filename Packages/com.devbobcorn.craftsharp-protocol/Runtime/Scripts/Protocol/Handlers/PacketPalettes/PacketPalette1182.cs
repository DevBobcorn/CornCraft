...
{
    public class PacketPalette1182 : PacketTypePalette
    {
        private readonly Dictionary<int, PacketTypesIn> typeIn = new()
        {
            ...
            { 0x13, PacketTypesIn.CloseInventory },
            { 0x14, PacketTypesIn.InventoryItems },
            { 0x15, PacketTypesIn.InventoryProperty },
            ...
            { 0x2E, PacketTypesIn.OpenInventory },
        ...
        private readonly Dictionary<int, PacketTypesOut> typeOut = new()
        {
            ...
            { 0x07, PacketTypesOut.ClickInventoryButton },
            { 0x08, PacketTypesOut.ClickInventory },
            { 0x09, PacketTypesOut.CloseInventory },
